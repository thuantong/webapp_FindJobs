!function (e, t) {
    ...
    C.fn = C.prototype = {
        ...
        for ('boolean' == typeof s && (u = s, s = arguments[a] || {}, a++), 'object' == typeof s || y(s) || (s = {}), a === l && (s = this, a--); a < l; a++) {
            if (null != (e = arguments[a])) {
                for (t in e) {
                    i = e[t], '__proto__' !== t && s !== i && (u && i && (C.isPlainObject(i) || (r = Array.isArray(i))) ? (n = s[t], o = r && !Array.isArray(n) ? [] : r || C.isPlainObject(n) ? n : {}, r = !1, s[t] = C.extend(u, o, i)) : void 0 !== i && (s[t] = i));
                }
            }
        }
        return s;
    ...
    var p = function (n) {
        var e, h, _, o, r, p, f, g, w, l, u, E, T, s, x, m, a, c, v, C = 'sizzle' + 1 * new Date, y = n.document, S = 0,
            i = 0, d = le(), b = le(), A = le(), D = le(), N = function (e, t) {
                return e === t && (u = !0), 0;
            ...
            M = '\\[' + R + '*(' + q + ')(?:' + R + '*([*^$|!~]?=)' + R + '*(?:\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)"|(' + q + '))|)' + R + '*\\]',
            W = ':(' + q + ')(?:\\(((\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|' + M + ')*)|.*)\\)|)',
            F = new RegExp(R + '+', 'g'), B = new RegExp('^' + R + '+|((?:^|[^\\\\])(?:\\\\.)*)' + R + '+$', 'g'),
            U = new RegExp('^' + R + '*,' + R + '*'), z = new RegExp('^' + R + '*([>+~]|' + R + ')' + R + '*'),
            Q = new RegExp(R + '|>'), $ = new RegExp(W), K = new RegExp('^' + q + '$'), V = {
                ID: new RegExp('^#(' + q + ')'),
                CLASS: new RegExp('^\\.(' + q + ')'),
                TAG: new RegExp('^(' + q + '|[*])'),
                ATTR: new RegExp('^' + M),
                ...
                if (11 !== d && (l = Z.exec(t))) {
                    if (r = l[1]) {
                        ...
                        if ((r = l[3]) && h.getElementsByClassName && e.getElementsByClassName) {
                            return L.apply(n, e.getElementsByClassName(r)), n;
                        }
                    }
                }
                if (h.qsa && !D[t + ' '] && (!m || !m.test(t)) && (1 !== d || 'object' !== e.nodeName.toLowerCase())) {
                    if (c = t, f = e, 1 === d && Q.test(t)) {
                        for ((a = e.getAttribute('id')) ? a = a.replace(ie, re) : e.setAttribute('id', a = C), o = (u = p(t)).length; o--;) {
                            u[o] = '#' + a + ' ' + be(u[o]);
                        }
        ...
        for (e in h = ae.support = {}, r = ae.isXML = function (e) {
            ...
            if ((e.ownerDocument || e) !== T && E(e), h.matchesSelector && x && !D[t + ' '] && (!a || !a.test(t)) && (!m || !m.test(t))) {
                try {
                    var n = c.call(e, t);
                    ...
                    return 1 === g && 0 === m ? function (e) {
                        ...
                        if (c) {
                            ...
                            if (l = [y ? c.firstChild : c.lastChild], y && d) {
                                ...
                                for (; (s = ++a && s && s[u] || (h = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++h || (d && ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, h]), s !== e));) {
                                    ;
                                }
                            }
            ...
            pseudos: {
                not: ue(function (e) {
                    ...
                    return K.test(n || '') || ae.error('unsupported lang: ' + n), n = n.replace(te, ne).toLowerCase(), function (e) {
                        var t;
                        do {
        ...
        function _e(a, e, t) {
            ...
            return e.first ? function (e, t, n) {
                ...
                if (n) {
                    ...
                    for (; e = e[l];) {
                        if (1 === e.nodeType || f) {
                            if (r = (o = e[C] || (e[C] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), u && u === e.nodeName.toLowerCase()) {
                                e = e[l] || e;
                            } else {
        ...
        function Te(h, p, g, m, v, e) {
            return m && !m[C] && (m = Te(m)), v && !v[C] && (v = Te(v, e)), ue(function (e, t, n, i) {
                var r, o, s, a = [], l = [], u = t.length, c = e || function (e, t, n) {
                        ...
                        return n;
                    }(p || '*', n.nodeType ? [n] : n, []), f = !h || !e && p ? c : Ee(c, a, h, n, i),
                    d = g ? v || (e ? h : u || m) ? [] : t : f;
                if (g && g(f, d, n, i), m) {
                ...
                if (e) {
                    ...
                    d = Ee(d === t ? d.splice(u, d.length) : d), v ? v(null, t, d, i) : L.apply(t, d);
                }
            });
        }
            ...
            for (var r, t, n, i = e.length, o = _.relative[e[0].type], s = o || _.relative[' '], a = o ? 1 : 0, l = _e(function (e) {
                ...
                if (t = _.relative[e[a].type]) {
                    ...
                    if ((t = _.filter[e[a].type].apply(null, e[a].matches))[C]) {
                        ...
                        return Te(1 < a && we(c), 1 < a && be(e.slice(0, a - 1).concat({value: ' ' === e[a - 2].type ? '*' : ''})).replace(B, '$1'), t, a < n && xe(e.slice(a, n)), n < i && xe(e = e.slice(n)), n < i && be(e));
                    }
                    c.push(t);
                }
            }
        ...
        return ye.prototype = _.filters = _.pseudos, _.setFilters = new ye, p = ae.tokenize = function (e, t) {
            ...
            for (s = e, a = [], l = _.preFilter; s;) {
                for (o in n && !(i = U.exec(s)) || (i && (s = s.slice(i[0].length) || s), a.push(r = [])), n = !1, (i = z.exec(s)) && (n = i.shift(), r.push({
                    ...
                    !(i = V[o].exec(s)) || l[o] && !(i = l[o](i)) || (n = i.shift(), r.push({
                        value: n,
                        type: o,
                        matches: i,
                    }), s = s.slice(n.length));
            ...
            if (!s) {
                ...
                (s = A(e, (m = o, y = 0 < (v = r).length, b = 0 < m.length, i = function (e, t, n, i, r) {
                    var o, s, a, l = 0, u = '0', c = e && [], f = [], d = w, h = e || b && _.find.TAG('*', r),
    ...
    C.Callbacks = function (i) {
        ...
        var r, t, o, s, a = [], l = [], u = -1, c = function () {
            for (s = s || i.once, o = r = !0; l.length; u = -1) {
                for (t = l.shift(); ++u < a.length;) {
                    !1 === a[u].apply(t[0], t[1]) && i.stopOnFalse && (u = a.length, t = !1);
                }
            }
        ...
        Deferred: function (e) {
            ...
            if (n <= 1 && (M(e, o.done(s(t)).resolve, o.reject, !n), 'pending' === o.state() || y(r[t] && r[t].then))) {
                return o.then();
            }
            for (; t--;) {
                M(r[t], s(t), o.reject);
    ...
    var X = new Y, G = new Y, J = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Z = /[A-Z]/g;
    ...
    C.extend({
        ...
        data: function (n, e) {
            ...
            if (this.length && (r = G.get(o), 1 === o.nodeType && !X.get(o, 'hasDataAttrs'))) {
                for (t = s.length; t--;) {
                    s[t] && 0 === (i = s[t].name).indexOf('data-') && (i = K(i.slice(5)), ee(o, i, r[i]));
                }
        ...
        queue: function (e, t, n) {
            var i;
            if (e) {
                return t = (t || 'fx') + 'queue', i = X.get(e, t), n && (!i || Array.isArray(n) ? i = X.access(e, t, C.makeArray(n)) : i.push(n)), i || [];
            }
    ...
    var te = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ne = new RegExp('^(?:([+-])=|)(' + te + ')([a-z%]*)$', 'i'),
        ie = ['Top', 'Right', 'Bottom', 'Left'], re = x.documentElement, oe = function (e) {
        ...
        for (var o, s, a, l, u, c, f = t.createDocumentFragment(), d = [], h = 0, p = e.length; h < p; h++) {
            if ((o = e[h]) || 0 === o) {
                if ('object' === w(o)) {
                    ...
                    for (s = s || f.appendChild(t.createElement('div')), a = (he.exec(o) || ['', ''])[1].toLowerCase(), l = ge[a] || ge._default, s.innerHTML = l[1] + C.htmlPrefilter(o) + l[2], c = l[0]; c--;) {
                        s = s.lastChild;
                    }
        ...
        o ? (X.set(e, r, !1), C.event.add(e, r, {
            namespace: !1, handler: function (e) {
                ...
                if (1 & e.isTrigger && this[r]) {
                    ...
                    } else if (i = a.call(arguments), X.set(this, r, i), t = o(this, r), this[r](), i !== (n = X.get(this, r)) || t ? X.set(this, r, !1) : n = void 0, i !== n) {
                        return e.stopImmediatePropagation(), e.preventDefault(), n;
                    }
                } else {
                    i && (X.set(this, r, C.event.trigger(C.extend(i.shift(), C.Event.prototype), i, this)), e.stopImmediatePropagation());
                }
            },
        })) : C.event.add(e, r, Ce);
    }
        ...
        global: {}, add: function (t, e, n, i, r) {
            ...
            if (m) {
                for (n.handler && (n = (o = n).handler, r = o.selector), r && C.find.matchesSelector(re, r), n.guid || (n.guid = C.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                    ...
                    h = g = (a = xe.exec(e[u]) || [])[1], p = (a[2] || '').split('.').sort(), h && (f = C.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, f = C.event.special[h] || {}, c = C.extend({
                        type: h,
                        origType: g,
                        data: i,
                        handler: n,
            ...
            var t, n, i, r, o, s, a = C.event.fix(e), l = new Array(arguments.length),
                u = (X.get(this, 'events') || {})[a.type] || [], c = C.event.special[a.type] || {};
            ...
            if (l && u.nodeType && !('click' === e.type && 1 <= e.button)) {
                for (; u !== this; u = u.parentNode || this) {
                    if (1 === u.nodeType && ('click' !== e.type || !0 !== u.disabled)) {
                        for (o = [], s = {}, n = 0; n < l; n++) {
                            void 0 === s[r = (i = t[n]).selector + ' '] && (s[r] = i.needsContext ? -1 < C(r, this).index(u) : C.find(r, this, null, [u]).length), s[r] && o.push(i);
                        }
    ...
    var Ie = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
        ke = /<script|<style|<link/i, Oe = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Le = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function qe(n, i, r, o) {
        ...
        if (f && (t = (e = we(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            for (a = (s = C.map(me(e, 'script'), He)).length; c < f; c++) {
                l = e, c !== d && (l = C.clone(l, !0, !0), a && C.merge(s, me(l, 'script'))), r.call(n[c], l, c);
            }
            if (a) {
                for (u = s[s.length - 1].ownerDocument, C.map(s, Pe), c = 0; c < a; c++) {
                    l = s[c], pe.test(l.type || '') && !X.access(l, 'globalEval') && C.contains(u, l) && (l.src && 'module' !== (l.type || '').toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {nonce: l.nonce || l.getAttribute('nonce')}) : _(l.textContent.replace(Le, ''), l, u));
                }
            }
        }
        return n;
    ...
    function Me(e, t, n) {
        for (var i, r = t ? C.filter(t, e) : e, o = 0; null != (i = r[o]); o++) {
            n || 1 !== i.nodeType || C.cleanData(me(i)), i.parentNode && (n && oe(i) && ve(me(i, 'script')), i.parentNode.removeChild(i));
        }
        return e;
    }
    ...
    C.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e))) {
                for (s = me(c), i = 0, r = (o = me(e)).length; i < r; i++) {
                    a = o[i], l = s[i], void 0, 'input' === (u = l.nodeName.toLowerCase()) && de.test(a.type) ? l.checked = a.checked : 'input' !== u && 'textarea' !== u || (l.defaultValue = a.defaultValue);
                }
            }
            if (t) {
                if (n) {
        ...
        C.fn[e] = function (e) {
            for (var t, n = [], i = C(e), r = i.length - 1, o = 0; o <= r; o++) {
                t = o === r ? this : this.clone(!0), C(i[o])[s](t), l.apply(n, t.get());
            }
            return this.pushStack(n);
        };
    });
    var We = new RegExp('^(' + te + ')(?!px)[a-z%]+$', 'i'), Fe = function (e) {
    ...
    var Qe = ['Webkit', 'Moz', 'ms'], $e = x.createElement('div').style, Ke = {};
    ...
    function et(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2) {
            'margin' === n && (l += C.css(e, n + ie[s], !0, r)), i ? ('content' === n && (l -= C.css(e, 'padding' + ie[s], !0, r)), 'margin' !== n && (l -= C.css(e, 'border' + ie[s] + 'Width', !0, r))) : (l += C.css(e, 'padding' + ie[s], !0, r), 'padding' !== n ? l += C.css(e, 'border' + ie[s] + 'Width', !0, r) : a += C.css(e, 'border' + ie[s] + 'Width', !0, r));
        }
        return !i && 0 <= o && (l += Math.max(0, Math.ceil(e['offset' + t[0].toUpperCase() + t.slice(1)] - o - l - a - .5)) || 0), l;
    }

    function tt(e, t, n) {
        var i = Fe(e), r = (!v.boxSizingReliable() || n) && 'border-box' === C.css(e, 'boxSizing', !1, i), o = r,
            s = Ue(e, t, i), a = 'offset' + t[0].toUpperCase() + t.slice(1);
        if (We.test(s)) {
            if (!n) {
                return s;
            }
    ...
    C.extend({
        ...
        C.cssHooks[l] = {
            get: function (e, t, n) {
                ...
                var i, r = Fe(e), o = !v.scrollboxSize() && 'absolute' === r.position,
                    s = (o || n) && 'border-box' === C.css(e, 'boxSizing', !1, r), a = n ? et(e, l, n, s, r) : 0;
        ...
        if (t) {
            return (parseFloat(Ue(e, 'marginLeft')) || e.getBoundingClientRect().left - le(e, {marginLeft: 0}, function () {
    ...
    function ht(o, e, t) {
        ...
        for (!function (e, t) {
            ...
            if (n = ht.prefilters[i].call(u, o, c, u.opts)) {
                return y(n.stop) && (C._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
            }
        }
    ...
    C.Animation = C.extend(ht, {
        tweeners: {
            ...
            for (var n, i = 0, r = (e = y(e) ? (t = e, ['*']) : e.match(P)).length; i < r; i++) {
                n = e[i], ht.tweeners[n] = ht.tweeners[n] || [], ht.tweeners[n].unshift(t);
            }
        }, prefilters: [function (e, t, n) {
            var i, r, o, s, a, l, u, c, f = 'width' in t || 'height' in t, d = this, h = {}, p = e.style,
                g = e.nodeType && ae(e), m = X.get(e, 'fxshow');
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(h)) {
                for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = m && m.display) && (u = X.get(e, 'display')), 'none' === (c = C.css(e, 'display')) && (u ? c = u : (fe([e], !0), u = e.style.display || u, c = C.css(e, 'display'), fe([e]))), ('inline' === c || 'inline-block' === c && null != u) && 'none' === C.css(e, 'float') && (l || (d.done(function () {
                    ...
                    l || (m ? 'hidden' in m && (g = m.hidden) : m = X.access(e, 'fxshow', {display: u}), o && (m.hidden = !g), g && fe([e], !0), d.done(function () {
                        for (i in g || fe([e]), X.remove(e, 'fxshow'), h) {
                            C.style(e, i, h[i]);
                        }
        ...
        fadeTo: function (e, t, n, i) {
            ...
            return 'string' != typeof r && (o = e, e = r, r = void 0), e && !1 !== r && this.queue(r || 'fx', []), this.each(function () {
                var e = !0, t = null != r && r + 'queueHooks', n = C.timers, i = X.get(this);
                if (t) {
                    i[t] && i[t].stop && s(i[t]);
                } else {
                    for (t in i) {
            ...
            return !1 !== s && (s = s || 'fx'), this.each(function () {
                ...
                for (t.finish = !0, C.queue(this, s, []), i && i.stop && i.stop.call(this, !0), e = r.length; e--;) {
    ...
    C.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) {
                return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? pt : void 0)), void 0 !== n ? null === n ? void C.removeAttr(e, t) : r && 'set' in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ''), n) : r && 'get' in r && null !== (i = r.get(e, t)) ? i : null == (i = C.find.attr(e, t)) ? void 0 : i);
            }
        }, attrHooks: {
            type: {
                set: function (e, t) {
    ...
    C.fn.extend({
        ...
        addClass: function (t) {
            ...
            return 'boolean' == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : y(r) ? this.each(function (e) {
                ...
                var e, t, n, i;
                if (s) {
                    for (t = 0, n = C(this), i = _t(r); e = i[t++];) {
                        n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                    }
                } else {
                    void 0 !== r && 'boolean' !== o || ((e = bt(this)) && X.set(this, '__className__', e), this.setAttribute && this.setAttribute('class', e || !1 === r ? '' : X.get(this, '__className__') || ''));
                }
            });
        }, hasClass: function (e) {
            var t, n, i = 0;
    ...
    C.extend(C.event, {
        trigger: function (e, t, n, i) {
            var r, o, s, a, l, u, c, f, d = [n || x], h = m.call(e, 'type') ? e.type : e,
            ...
            if (o = f = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !Et.test(h + C.event.triggered) && (-1 < h.indexOf('.') && (h = (p = h.split('.')).shift(), p.sort()), l = h.indexOf(':') < 0 && 'on' + h, (e = e[C.expando] ? e : new C.Event(h, 'object' == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join('.'), e.rnamespace = e.namespace ? new RegExp('(^|\\.)' + p.join('\\.(?:.*\\.|)') + '(\\.|$)') : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), c = C.event.special[h] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!i && !c.noBubble && !b(n)) {
                    for (a = c.delegateType || h, Et.test(a + h) || (o = o.parentNode); o; o = o.parentNode) {
                        d.push(o), s = o;
                    }
                    s === (n.ownerDocument || x) && d.push(s.defaultView || s.parentWindow || T);
                }
                for (r = 0; (o = d[r++]) && !e.isPropagationStopped();) {
                    f = o, e.type = 1 < r ? a : c.bindType || h, (u = (X.get(o, 'events') || {})[e.type] && X.get(o, 'handle')) && u.apply(o, t), (u = l && o[l]) && u.apply && V(o) && (e.result = u.apply(o, t), !1 === e.result && e.preventDefault());
                }
    ...
    var xt = T.location, Ct = Date.now(), St = /\?/;
    ...
    var Ot = /%20/g, Lt = /#.*$/, jt = /([?&])_=[^&]*/, Ht = /^(.*?):[ \t]*([^\r\n]*)$/gm, Pt = /^(?:GET|HEAD)$/,
        Rt = /^\/\//, qt = {}, Mt = {}, Wt = '*/'.concat('*'), Ft = x.createElement('a');
    ...
    Ft.href = xt.href, C.extend({
        ...
        ajax: function (e, t) {
            ...
            var c, f, d, n, h, i, p, g, r, o, m = C.ajaxSetup({}, t), v = m.context || m,
                y = m.context && (v.nodeType || v.jquery) ? C(v) : C.event, b = C.Deferred(),
                _ = C.Callbacks('once memory'), w = m.statusCode || {}, s = {}, a = {}, l = 'canceled', E = {
            ...
            if (m.data && m.processData && 'string' != typeof m.data && (m.data = C.param(m.data, m.traditional)), Ut(qt, m, t, E), p) {
                return E;
            }
            for (r in (g = C.event && m.global) && 0 == C.active++ && C.event.trigger('ajaxStart'), m.type = m.type.toUpperCase(), m.hasContent = !Pt.test(m.type), f = m.url.replace(Lt, ''), m.hasContent ? m.data && m.processData && 0 === (m.contentType || '').indexOf('application/x-www-form-urlencoded') && (m.data = m.data.replace(Ot, '+')) : (o = m.url.slice(f.length), m.data && (m.processData || 'string' == typeof m.data) && (f += (St.test(f) ? '&' : '?') + m.data, delete m.data), !1 === m.cache && (f = f.replace(jt, '$1'), o = (St.test(f) ? '&' : '?') + '_=' + Ct++ + o), m.url = f + o), m.ifModified && (C.lastModified[f] && E.setRequestHeader('If-Modified-Since', C.lastModified[f]), C.etag[f] && E.setRequestHeader('If-None-Match', C.etag[f])), (m.data && m.hasContent && !1 !== m.contentType || t.contentType) && E.setRequestHeader('Content-Type', m.contentType), E.setRequestHeader('Accept', m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ('*' !== m.dataTypes[0] ? ', ' + Wt + '; q=0.01' : '') : m.accepts['*']), m.headers) {
    ...
    var Qt = {0: 200, 1223: 204}, $t = C.ajaxSettings.xhr();
        ...
        if (v.cors || $t && !r.crossDomain) {
            return {
                send: function (e, t) {
                    ...
                    for (n in r.mimeType && i.overrideMimeType && i.overrideMimeType(r.mimeType), r.crossDomain || e['X-Requested-With'] || (e['X-Requested-With'] = 'XMLHttpRequest'), e) {
    ...
    C.ajaxSetup({
        ...
        if (s || 'jsonp' === e.dataTypes[0]) {
            return i = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Yt, '$1' + i) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? '&' : '?') + e.jsonp + '=' + i), e.converters['script json'] = function () {
        ...
        C.fn[t] = function (e) {
            return U(this, function (e, t, n) {
                var i;
                if (b(e) ? i = e : 9 === e.nodeType && (i = e.defaultView), void 0 === n) {
                    return i ? i[r] : e[t];
                }
        ...
        C.cssHooks[n] = ze(v.pixelPosition, function (e, t) {
            if (t) {
                return t = Ue(e, n), We.test(t) ? C(e).position()[n] + 'px' : t;
            }
        });
    ...
    var v = 'button', y = 'bs.button', b = '.' + y, _ = '.data-api', w = p.fn[v], E = 'active', T = 'btn', x = 'focus',
        C = '[data-toggle^="button"]', S = '[data-toggle="buttons"]', A = 'input:not([type="hidden"])', D = '.active',
        N = '.btn', I = {CLICK_DATA_API: 'click' + b + _, FOCUS_BLUR_DATA_API: 'focus' + b + _ + ' blur' + b + _},
        k = function () {
            function n(e) {
                this._element = e;
            }
    ...
    var O = 'carousel', L = 'bs.carousel', j = '.' + L, H = '.data-api', P = p.fn[O],
        R = {interval: 5e3, keyboard: !0, slide: !1, pause: 'hover', wrap: !0, touch: !0}, q = {
            ...
            wrap: 'boolean',
            touch: 'boolean',
        }, M = 'next', W = 'prev', F = 'left', B = 'right', U = {
            SLIDE: 'slide' + j,
            SLID: 'slid' + j,
            KEYDOWN: 'keydown' + j,
        ...
        }, z = 'carousel', Q = 'active', $ = 'slide', K = 'carousel-item-right', V = 'carousel-item-left',
        ...
        ae = function () {
            ...
            return e.next = function () {
                ...
                if (r = e === M ? (n = V, i = Y, F) : (n = K, i = X, B), l && p(l).hasClass(Q)) {
                    this._isSliding = !1;
                    ...
                    if (p(this._element).hasClass($)) {
                        ...
                        p(s).removeClass(Q), p(l).addClass(Q), this._isSliding = !1, p(this._element).trigger(f);
                    }
                    c && this.cycle();
                }
            }, o._jQueryInterface = function (i) {
                return this.each(function () {
                    var e = p(this).data(L), t = l({}, R, p(this).data());
                    'object' == typeof i && (t = l({}, t, i));
                    var n = 'string' == typeof i ? i : t.slide;
                    if (e || (e = new o(this, t), p(this).data(L, e)), 'number' == typeof i) {
                        e.to(i);
    ...
    var le = 'collapse', ue = 'bs.collapse', ce = '.' + ue, fe = p.fn[le], de = {toggle: !0, parent: ''},
        he = {toggle: 'boolean', parent: '(string|element)'}, pe = {
            SHOW: 'show' + ce,
            SHOWN: 'shown' + ce,
            HIDE: 'hide' + ce,
            HIDDEN: 'hidden' + ce,
            CLICK_DATA_API: 'click' + ce + '.data-api',
        }, ge = 'show', me = 'collapse', ve = 'collapsing', ye = 'collapsed', be = 'width', _e = 'height',
        we = '.show, .collapsing', Ee = '[data-toggle="collapse"]', Te = function () {
            ...
            return e.toggle = function () {
                ...
                return this.each(function () {
                    var e = p(this), t = e.data(ue), n = l({}, de, e.data(), 'object' == typeof i && i ? i : {});
    ...
    function Ve(e, t) {
        var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = He(10), r = 'HTML' === t.nodeName,
            o = Ke(e), s = Ke(t), a = Oe(e), l = Ie(t), u = parseFloat(l.borderTopWidth, 10),
            c = parseFloat(l.borderLeftWidth, 10);
        n && r && (s.top = Math.max(s.top, 0), s.left = Math.max(s.left, 0));
        var f = $e({top: o.top - s.top - u, left: o.left - s.left - c, width: o.width, height: o.height});
        ...
        if ('viewport' === i) {
            o = function (e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                    n = e.ownerDocument.documentElement, i = Ve(e, n),
    ...
    function Ge(e, t, i, n, r) {
        ...
        var s = Xe(i, n, o, r), a = {
            ...
            return Qe({key: e}, a[e], {area: (t = a[e], t.width * t.height)});
            var t;
        }).sort(function (e, t) {
            ...
            shift: {
                order: 100, enabled: !0, fn: function (e) {
                    ...
                    if (i) {
                        var r = e.offsets, o = r.reference, s = r.popper, a = -1 !== ['bottom', 'top'].indexOf(n),
                            ...
                            c = {start: ze({}, l, o[l]), end: ze({}, l, o[l] + o[u] - s[u])};
                ...
                order: 500, enabled: !0, fn: function (e, t) {
                    ...
                    var r = e.placement.split('-')[0], o = e.offsets, s = o.popper, a = o.reference,
                        ...
                        f = c.toLowerCase(), d = l ? 'left' : 'top', h = l ? 'bottom' : 'right', p = Ze(i)[u];
                    ...
                    var g = a[f] + a[u] / 2 - p / 2, m = Ie(e.instance.popper), v = parseFloat(m['margin' + c], 10),
                        y = parseFloat(m['border' + c + 'Width'], 10), b = g - e.offsets.popper[f] - v - y;
                ...
                order: 600, enabled: !0, fn: function (p, g) {
                    ...
                    var m = Xe(p.instance.popper, p.instance.reference, g.padding, g.boundariesElement, p.positionFixed),
                        v = p.placement.split('-')[0], y = et(v), b = p.placement.split('-')[1] || '', _ = [];
                    switch (g.behavior) {
                        case mt:
                            _ = [v, y];
                            break;
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    ...
                    var s, a, l, u, c, f, d, h, p, g, m, v, y, b, _ = void 0 !== o ? o : t.gpuAcceleration,
                        w = Pe(e.instance.popper), E = Ke(w), T = {position: r.position},
                        ...
                        A = ot('transform'), D = void 0, N = void 0;
                    if (N = 'bottom' === C ? 'HTML' === w.nodeName ? -w.clientHeight + x.bottom : -E.height + x.bottom : x.top, D = 'right' === S ? 'HTML' === w.nodeName ? -w.clientWidth + x.right : -E.width + x.right : x.left, _ && A) {
                        T[A] = 'translate3d(' + D + 'px, ' + N + 'px, 0)', T[C] = 0, T[S] = 0, T.willChange = 'transform';
                    } else {
    ...
    var Et = 'dropdown', Tt = 'bs.dropdown', xt = '.' + Tt, Ct = '.data-api', St = p.fn[Et],
        ...
        Ht = 'position-static', Pt = '[data-toggle="dropdown"]', Rt = '.dropdown form', qt = '.dropdown-menu',
        Mt = '.navbar-nav', Wt = '.dropdown-menu .dropdown-item:not(.disabled):not(:disabled)', Ft = 'top-start',
        Bt = 'top-end', Ut = 'bottom-start', zt = 'bottom-end', Qt = 'right-start', $t = 'left-start',
        Kt = {offset: 0, flip: !0, boundary: 'scrollParent', reference: 'toggle', display: 'dynamic'}, Vt = {
            ...
            return e.toggle = function () {
                if (!this._element.disabled && !p(this._element).hasClass(Nt)) {
                    ...
                    if (u._clearMenus(), !t) {
                        var n = {relatedTarget: this._element}, i = p.Event(Dt.SHOW, n);
                ...
                if (!(this._element.disabled || p(this._element).hasClass(Nt) || p(this._menu).hasClass(It))) {
                    var e = {relatedTarget: this._element}, t = p.Event(Dt.SHOW, e),
                ...
                if (!this._element.disabled && !p(this._element).hasClass(Nt) && p(this._menu).hasClass(It)) {
                    var e = {relatedTarget: this._element}, t = p.Event(Dt.HIDE, e),
                        n = u._getParentFromElement(this._element);
    ...
    var Xt = 'modal', Gt = 'bs.modal', Jt = '.' + Gt, Zt = p.fn[Xt],
        ...
        ln = 'fade', un = 'show', cn = '.modal-dialog', fn = '.modal-body', dn = '[data-toggle="modal"]',
        hn = '[data-dismiss="modal"]', pn = '.fixed-top, .fixed-bottom, .is-fixed, .sticky-top', gn = '.sticky-top',
        mn = function () {
            function r(e, t) {
            ...
            return e.toggle = function (e) {
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    }), n && g.reflow(this._backdrop), p(this._backdrop).addClass(un), !e) {
                        return;
                    }
                    if (!n) {
                        return void e();
    ...
    var En = 'tooltip', Tn = 'bs.tooltip', xn = '.' + Tn, Cn = p.fn[En], Sn = 'bs-tooltip',
        An = new RegExp('(^|\\s)' + Sn + '\\S+', 'g'), Dn = ['sanitize', 'whiteList', 'sanitizeFn'], Nn = {
            animation: 'boolean',
            template: 'string',
        ...
        }, Hn = 'fade', Pn = 'show', Rn = '.tooltip-inner', qn = '.arrow', Mn = 'hover', Wn = 'focus', Fn = 'click',
        Bn = 'manual', Un = function () {
            ...
            return e.enable = function () {
                ...
                var e = p(this.getTipElement()), t = e.attr('class').match(An);
    ...
    var zn = 'popover', Qn = 'bs.popover', $n = '.' + Qn, Kn = p.fn[zn], Vn = 'bs-popover',
        Yn = new RegExp('(^|\\s)' + Vn + '\\S+', 'g'), Xn = l({}, Un.Default, {
            placement: 'right',
            trigger: 'click',
            content: '',
        ...
        ei = '.popover-header', ti = '.popover-body', ni = {
            ...
            return r.isWithContent = function () {
                ...
                return this.each(function () {
                    var e = p(this).data(Qn), t = 'object' == typeof n ? n : null;
    ...
    var ri = 'scrollspy', oi = 'bs.scrollspy', si = '.' + oi, ai = p.fn[ri],
        ...
        fi = 'dropdown-item', di = 'active', hi = '[data-spy="scroll"]', pi = '.nav, .list-group', gi = '.nav-link',
        mi = '.nav-item', vi = '.list-group-item', yi = '.dropdown', bi = '.dropdown-item', _i = '.dropdown-toggle',
        wi = 'offset', Ei = 'position', Ti = function () {
            ...
            return e.refresh = function () {
                ...
                n.hasClass(fi) ? (n.closest(yi).find(_i).addClass(di), n.addClass(di)) : (n.addClass(di), n.parents(pi).prev(gi + ', ' + vi).addClass(di), n.parents(pi).prev(mi).children(gi).addClass(di)), p(this._scrollElement).trigger(ci.ACTIVATE, {relatedTarget: t});
            }, e._clear = function () {
    ...
    var xi = 'bs.tab', Ci = '.' + xi, Si = p.fn.tab, Ai = {
            HIDE: 'hide' + Ci,
            HIDDEN: 'hidden' + Ci,
            SHOW: 'show' + Ci,
            SHOWN: 'shown' + Ci,
            CLICK_DATA_API: 'click' + Ci + '.data-api',
        }, Di = 'dropdown-menu', Ni = 'active', Ii = 'disabled', ki = 'fade', Oi = 'show', Li = '.dropdown',
        ji = '.nav, .list-group', Hi = '.active', Pi = '> li > .active',
        Ri = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', qi = '.dropdown-toggle',
        Mi = '> .dropdown-menu .active', Wi = function () {
            ...
            return e.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Ni) || p(this._element).hasClass(Ii))) {
                    ...
                    var s = p.Event(Ai.HIDE, {relatedTarget: this._element}), a = p.Event(Ai.SHOW, {relatedTarget: i});
    ...
    var Fi = 'toast', Bi = 'bs.toast', Ui = '.' + Bi, zi = p.fn[Fi], Qi = {
            CLICK_DISMISS: 'click.dismiss' + Ui,
            HIDE: 'hide' + Ui,
            HIDDEN: 'hidden' + Ui,
            SHOW: 'show' + Ui,
            SHOWN: 'shown' + Ui,
        }, $i = 'fade', Ki = 'hide', Vi = 'show', Yi = 'showing',
    ...
    }(), e.Util = g, e.Alert = m, e.Button = k, e.Carousel = ae, e.Collapse = Te, e.Dropdown = Yt, e.Modal = mn, e.Popover = ii, e.Scrollspy = Ti, e.Tab = Wi, e.Toast = Zi, e.Tooltip = Un, Object.defineProperty(e, '__esModule', {value: !0});
}), function (D) {
    D.fn.extend({
        slimScroll: function (S) {
            ...
            return this.each(function () {
                ...
                if (d.parent().hasClass(A.wrapperClass)) {
                    ...
                    if (b = d.siblings('.' + A.barClass), y = d.siblings('.' + A.railClass), T(), D.isPlainObject(S)) {
                        ...
                        if ('scrollTo' in S) {
                            ...
                            return b.remove(), y.remove(), void d.unwrap();
                        }
                        E(h, !1, !0);
                    }
                    ...
                    d.css({overflow: 'hidden', width: A.width, height: A.height});
                    var v, y = D(u).addClass(A.railClass).css({
                        ...
                        zIndex: 99,
                    }), _ = 'right' == A.position ? {right: A.distance} : {left: A.distance};
                    ...
                    }), T(), 'bottom' === A.start ? (b.css({top: d.outerHeight() - b.outerHeight()}), E(0, !0)) : 'top' !== A.start && (E(D(A.start).position().top, null, !0), A.alwaysVisible || b.hide()), v = this, window.addEventListener ? (v.addEventListener('DOMMouseScroll', w, !1), v.addEventListener('mousewheel', w, !1)) : document.attachEvent('onmousewheel', w);
                }
                ...
                function E(e, t, n) {
                    f = !1;
                    var i = e, r = d.outerHeight() - b.outerHeight();
                    if (t && (i = parseInt(b.css('top')) + e * parseInt(A.wheelStep) / 100 * b.outerHeight(), i = Math.min(Math.max(i, 0), r), i = 0 < e ? Math.ceil(i) : Math.floor(i), b.css({top: i + 'px'})), i = (a = parseInt(b.css('top')) / (d.outerHeight() - b.outerHeight())) * (d[0].scrollHeight - d.outerHeight()), n) {
                ...
                function T() {
                    s = Math.max(d.outerHeight() / d[0].scrollHeight * d.outerHeight(), c), b.css({height: s + 'px'});
    ...
    'use strict';
    var t = t || {}, i = document.querySelectorAll.bind(document), s = Object.prototype.toString,
    ...
    function f(e) {
        var t, n, i, r, o = {top: 0, left: 0}, s = e && e.ownerDocument;
    ...
    var h = {
        duration: 750, delay: 200, show: function (e, t, n) {
            ...
            var a = 'scale(' + t.clientWidth / 100 * 3 + ')', l = 'translate(0,0)';
    ...
    function o(e, t, n) {
        if (n) {
            ...
            var i = n.getAttribute('data-x'), r = n.getAttribute('data-y'), o = n.getAttribute('data-scale'),
                s = n.getAttribute('data-translate'), a = 350 - (Date.now() - Number(n.getAttribute('data-hold')));
    ...
    function n(t) {
        ...
        if (null !== n) {
            ...
            if (u.registerEvent(t), 'touchstart' === t.type && h.delay) {
                var i = !1, r = setTimeout(function () {
                    r = null, h.show(t, n);
                }, h.delay), o = function (e) {
                ...
                h.show(t, n), a && (n.addEventListener('touchend', h.hide, !1), n.addEventListener('touchcancel', h.hide, !1)), n.addEventListener('mouseup', h.hide, !1), n.addEventListener('mouseleave', h.hide, !1);
            }
        }
    }
    ...
    return t.init = function (e) {
        ...
        for (var r = 0, o = e.length; r < o; r++) {
            i = (n = e[r]).tagName.toLowerCase(), -1 !== ['input', 'img'].indexOf(i) && (l[i](n), n = n.parentElement), -1 === n.className.indexOf('waves-effect') && (n.className += ' waves-effect' + t);
        }
        ...
        for (var t = {type: 'mouseup', button: 1}, n = 0, i = (e = c(e)).length; n < i; n++) {
            h.hide(t, e[n]);
        }
    ...
    var s = function (i) {
        ...
        }(a = a && a.hasOwnProperty('default') ? a.default : a), e = 'metisMenu', l = 'metisMenu', t = '.' + l, n = a.fn[e],
        u = {toggle: !0, preventDefault: !0, triggerElement: 'a', parentTrigger: 'li', subMenu: 'ul'}, c = {
            SHOW: 'show' + t,
            SHOWN: 'shown' + t,
            HIDE: 'hide' + t,
            HIDDEN: 'hidden' + t,
            CLICK_DATA_API: 'click' + t + '.data-api',
        }, i = 'metismenu', f = 'mm-active', d = 'mm-show', h = 'mm-collapse', p = 'mm-collapsing', r = function () {
            function r(e, t) {
            ...
            return e.init = function () {
                var o = this, s = this.config, e = a(this.element);
                e.addClass(i), e.find(s.parentTrigger + '.' + f).children(s.triggerElement).attr('aria-expanded', 'true'), e.find(s.parentTrigger + '.' + f).parents(s.parentTrigger).addClass(f), e.find(s.parentTrigger + '.' + f).parents(s.parentTrigger).children(s.triggerElement).attr('aria-expanded', 'true'), e.find(s.parentTrigger + '.' + f).has(s.subMenu).children(s.subMenu).addClass(h + ' ' + d), e.find(s.parentTrigger).not('.' + f).has(s.subMenu).children(s.subMenu).addClass(h), e.find(s.parentTrigger).children(s.triggerElement).on(c.CLICK_DATA_API, function (e) {
                    ...
                    if ("true" !== t.attr("aria-disabled")) {
                        ...
                        var n = t.parent(s.parentTrigger), i = n.siblings(s.parentTrigger),
                ...
                return this.each(function () {
                    var e = a(this), t = e.data(l), n = o({}, u, e.data(), "object" == typeof i && i ? i : {});
    ...
    t.prototype.queueTrigger = function (e) {
        ...
        for (var e in t.Context.refreshAll(), o) {
            o[e].enabled = !0;
        }
        return this
    ...
    var i = 0, r = {}, m = window.Waypoint, e = window.onload;
    n.prototype.add = function (e) {
        ...
        for (var r in this.handleScroll(), e = {
            ...
            for (var s in this.waypoints[r]) {
                var a, l, u, c, f = this.waypoints[r][s], d = f.options.offset, h = f.triggerPoint, p = 0,
                    g = null == h;
    ...
    v.fn.counterUp = function (e) {
        ...
        return this.each(function () {
            ...
            h.waypoint(function (e) {
                !function () {
                    var e = [], t = p.time / p.delay,
                        n = v(this).attr("data-num") ? v(this).attr("data-num") : h.text(), i = /[0-9]+,[0-9]+/.test(n),
                    ...
                    for (var l = t; l >= p.beginAt / n * t; l--) {
                        ...
                        if (o) {
                            u = parseInt(g / t * l);
                            var c = parseInt(u / 3600) % 24, f = parseInt(u / 60) % 60, d = parseInt(u % 60, 10);
