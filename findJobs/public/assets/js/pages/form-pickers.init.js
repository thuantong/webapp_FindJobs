!function (a) {
    ...
    t.prototype.init = function () {
        a("#basic-colorpicker").colorpicker(), a("#hex-colorpicker").colorpicker({format: "auto"}), a("#component-colorpicker").colorpicker({format: null}), a("#horizontal-colorpicker").colorpicker({horizontal: !0}), a(".clockpicker").clockpicker({donetext: "Done"}), a("#single-input").clockpicker({
            placement: "bottom",
            align: "left",
            autoclose: !0,
            default: "now"
        ...
        }), a(".input-daterange-datepicker").daterangepicker({
            ...
            cancelClass: "btn-primary",
            dateLimit: {days: 6}
        }), a("#reportrange span").html(moment().subtract(29, "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), a("#reportrange").daterangepicker({
            format: "MM/DD/YYYY",
