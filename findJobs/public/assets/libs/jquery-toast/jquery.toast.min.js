'function' != typeof Object.create && (Object.create = function (t) {
    ...
    var n = {
        ...
        setup: function () {
            var o = '';
            if (this._toastEl = this._toastEl || t('<div></div>', {'class': 'jq-toast-single'}), o += '<span class="jq-toast-loader"></span>', this.options.allowToastClose && (o += '<span class="close-jq-toast-single">x</span>'), this.options.text instanceof Array) {
