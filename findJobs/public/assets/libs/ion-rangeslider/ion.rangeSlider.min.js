            ...
            if (this.options) {
                ...
                if (!this.options.hide_from_to) {
                    if ('single' === this.options.type) {
                        t = h ? this.decorate(r[this.result.from]) : (o = this._prettify(this.result.from), this.decorate(o, this.result.from)), this.$cache.single.html(t), this.calcLabels(), this.labels.p_single_left < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = 'hidden' : this.$cache.min[0].style.visibility = 'visible', this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = 'hidden' : this.$cache.max[0].style.visibility = 'visible';
                    } else {
