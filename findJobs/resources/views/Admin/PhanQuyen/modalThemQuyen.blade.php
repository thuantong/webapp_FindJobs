<div class="modal fade" id="modal-them-quyen" tabindex="-1" role="dialog"
     aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalScrollableTitle">{{__('Tạo mới quyền')}}</h4>
                ...
                <div class="row center-element">
                    <div class="col-sm-11 col-md-11 pt-2 pb-2 border">
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-4 center-element">Tên quyền:</label>
                            <div class="col-sm-12 col-md-8">
                                <input class="form-control not-null" id="ten-quyen" title="Tên tác vụ">
