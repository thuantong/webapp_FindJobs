        ...
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
            <div class="card-box p-1 mb-1 text-right">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 text-left">
                        <select class="form-control not-null" id="gioi_tinh_tuyen_dung" title="Giới tính">
                            ...
                            <option value="1" @if($nhaTuyenDung['gioi_tinh_tuyen_dung'] != null && $nhaTuyenDung['gioi_tinh_tuyen_dung'] == 1) selected @endif>{{__('Nam')}}</option>
                            <option value="2" @if($nhaTuyenDung['gioi_tinh_tuyen_dung'] != null && $nhaTuyenDung['gioi_tinh_tuyen_dung'] == 2) selected @endif>{{__('Nữ')}}</option>
                        </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 text-left">
                        <input class="form-control not-null" id="ngay_sinh_tuyen_dung" title="Ngày sinh" value="@if($nhaTuyenDung['nam_sinh_tuyen_dung'] != null){{\Illuminate\Support\Carbon::createFromFormat('Y-m-d',$nhaTuyenDung['nam_sinh_tuyen_dung'])->format('d/m/Y')}}@else{{date('d/m/Y')}}@endif">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 center-element position-relative">
                        <div style="width: 8rem;height: 8rem;" id="avatar_tuyen_dung">
                            <img src="{{asset($nhaTuyenDung['avatar_tuyen_dung'])}}" class="avatar-xl img-thumbnail" data-src="{{$nhaTuyenDung['avatar_tuyen_dung']}}"
                                 alt="profile-image" tabindex="-1" style="width: 100%;height: 100%">
                            <div class="position-absolute center-element"
                                 style="display:none;width: 8rem;height: 8rem;background-color: rgba(50, 58, 70, .55);top:0">
                                <div>
