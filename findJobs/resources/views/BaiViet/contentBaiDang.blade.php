        ...
        <div class="card-box mb-1">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                    <input class="form-control not-null tieu_de_bai_dang" id="tieu_de_bai_dang" title="Tiêu đề bài viết">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    <select class="form-control not-null nganh_nghe" multiple id="nganh_nghe" title="Ngành nghề">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                        <textarea class="form-control break-custom not-null mo_ta_cong_viec" id="mo_ta_cong_viec"
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                        <textarea class="form-control break-custom not-null yeu_cau_cong_viec" id="yeu_cau_cong_viec"
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                        <textarea class="form-control break-custom not-null quyen_loi_cong_viec" id="quyen_loi_cong_viec"
