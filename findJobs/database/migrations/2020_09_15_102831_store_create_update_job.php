    ...
    public function up()
    {
        DB::unprepared('
            ...
            END IF;
                ...
                INSERT INTO jobs (tieu_de, luong, khu_vuc, han_tuyen, chuc_vu, kieu_lam_viec, so_luong_tuyen, nganh_nghe, kinh_nghiem, gioi_tinh, gioi_tinh_text, bang_cap, mo_ta, quyen_loi, yeu_cau_cong_viec, yeu_cau_ho_so, skill_basic, status, status_text, employer_id, isConfirm, isConfirm_text, isHot, isHot_text) VALUES
