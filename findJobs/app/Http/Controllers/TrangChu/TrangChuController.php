...
//        (tieu_de, luong, khu_vuc, han_tuyen, chuc_vu, kieu_lam_viec, so_luong_tuyen, nganh_nghe, kinh_nghiem, gioi_tinh, gioi_tinh_text, bang_cap, mo_ta, quyen_loi, yeu_cau_cong_viec, yeu_cau_ho_so, skill_basic, status, status_text, employer_id, isConfirm, isConfirm_text, isHot, isHot_text)
...
//        DB::insert('call create_job("Tieu de", 100000, 1, '.date('Y-m-d H:i:s').', "chuc_vu", 1, 100, "nganh_nghe", 100, 1, "bang_cap", "mo_ta", "quyen_loi", "yeu_cau_cong_viec", "yeu_cau_ho_so", "skill_basic", 0, 0, 0, 0)');
...
//        $jobs = new JobsModel();
//        $jobs ->newQuery('call create_job("Tieu de", 100000, 1, "'.date('Y-m-d H:i:s').'", "IN txtChucVu varchar(255)", 1, 1000, "IN txtnganh_nghe text", 12.0, 1, "IN txtbang_cap varchar(255)", "IN txtmo_ta text", "IN txtquyen_loi text", "IN txtyeu_cau_cong_viec text"," IN txtyeu_cau_ho_so text"," IN txtskill_basic text", 1, 2, 0, 0)');
//        $newJobs = $jobs->hydrate(
//                DB::insert('call create_job("Tieu de", 100000, 1, "'.date('Y-m-d H:i:s').'", "IN txtChucVu varchar(255)", 1, 1000, "IN txtnganh_nghe text", 12.0, 1, "IN txtbang_cap varchar(255)", "IN txtmo_ta text", "IN txtquyen_loi text", "IN txtyeu_cau_cong_viec text"," IN txtyeu_cau_ho_so text"," IN txtskill_basic text", 1, 2, 0, 0)')
//
//        );
//        $ar = $jobs->newQuery()->raw('call create_job("Tieu de", 100000, 1, "'.date('Y-m-d H:i:s').'", "IN txtChucVu varchar(255)", 1, 1000, "IN txtnganh_nghe text", 12.0, 1, "IN txtbang_cap varchar(255)", "IN txtmo_ta text", "IN txtquyen_loi text", "IN txtyeu_cau_cong_viec text"," IN txtyeu_cau_ho_so text"," IN txtskill_basic text", 1, 2, 0, 0)')->getValue();
//        dd($this->getStatusText(-1));
//        $jobs->save();
        //        array('');
//        $jobs = new JobsModel();
//        $jobs->tieu_de = 'cc';
